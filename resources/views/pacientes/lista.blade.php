        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading painel_cab">
                    Pacientes
                    <a class="btn btn-danger pull-right" href="{{ route('pacientes.create') }}">Novo</a>
                </div>
                    ...
                    <table id="paciente_table" class="table table-striped table-hover" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('pacientes.edit', $paciente->id) }}" class="btn btn-primary actions"><span class="glyphicon glyphicon-pencil"></span></a>
