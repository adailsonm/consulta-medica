        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading painel_cab">
                    Médicos
                    <a class="btn btn-danger pull-right" href="{{ route('medicos.create') }}">Novo</a>
                </div>
                    ...
                    <table id="medico_table" class="table table-striped table-hover" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="{{ route('medicos.edit', $medico->id) }}" class="btn btn-primary actions"><span class="glyphicon glyphicon-pencil"></a>
